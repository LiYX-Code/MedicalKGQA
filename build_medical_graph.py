...
class MedicalGraph(object):
	...
	def export_data(self):
		...
		f_drug = open('./words/drugs.txt', 'w+', encoding='utf-8')
		f_food = open('./words/foods.txt', 'w+', encoding='utf-8')
		f_check = open('./words/checks.txt', 'w+', encoding='utf-8')
		f_department = open('./words/departments.txt', 'w+', encoding='utf-8')
		f_symptom = open('./words/symptoms.txt', 'w+', encoding='utf-8')
		f_disease = open('./words/diseases.txt', 'w+', encoding='utf-8')
